...
class GameViewController: BaseViewController {
    ...
    private func loadNextTask() {
        ...
        if !State.shared.shownTasks.contains(self.tasks[counter].name) {
            State.shared.shownTasks.append(self.tasks[counter].name)
            userDefaults.set(State.shared.shownTasks, forKey: UDKeys.shownTasks)
        }
